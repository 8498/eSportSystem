...
@section('content')
    ...
    <section>
        ...
        {{ csrf_field() }}
            ...
            <input name="personal_detail_id" type="hidden" value="{{ $vars->personal_detail_id }}">
            <input name="id" type="hidden" value="{{ $vars->id }}">
            <div class="form-group">
                <div class="col-sm-8 col-sm-offset-2">
                    <label for="firstname">Imię</label>
                    <input name="firstname" type="text" class="form-control" value="{{ $vars->firstname }}">
                </div>
                <div class="col-sm-8 col-sm-offset-2">
                    <label for="lastname">Nazwisko</label>
                    <input name="lastname" type="text" class="form-control" value="{{ $vars->lastname }}">
                </div>
                @if($vars->office_id != App\Modules\Administration\Models\Office::getPlayer()->id)
                    <div class="col-sm-8 col-sm-offset-2">
